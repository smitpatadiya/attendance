  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="index.html"> <i class="icon-dashboard"></i>
         <span class="label label-important"></span> My Dashboard </a> </li>
        <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i>Charts</a> </li>
        <li class="bg_ly"> <a href="widgets.html"> 
        <i class="icon-inbox"></i><span class="label label-success"></span> Achievement </a> </li>
        <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> Target</a> </li>
        <li class="bg_lo"> <a href="tables.html"> <i class="icon-th"></i> Reports</a> </li>
    ...
    <div class="row-fluid">
      <div class="widget-box">
        <div class="widget-title bg_lg"><span class="icon"><i class="icon-signal"></i></span>
          <h5>Target Versus Achievement Analysis</h5>
        </div>
          ...
          <div class="row-fluid">
            ...
            <div class="span3">
              <ul class="site-stats">
                ...
                <li class="bg_lh"><i class="icon-shopping-cart"></i> <strong>656</strong> <small>Present Days</small></li>
                <li class="bg_lh"><i class="icon-tag"></i> <strong>9540</strong> <small>Absent Days</small></li>
                <li class="bg_lh"><i class="icon-repeat"></i> <strong>10</strong> <small>In-active Users</small></li>
                <li class="bg_lh"><i class="icon-globe"></i> <strong>8540</strong> <small>Active USers</small></li>
              </ul>
            </div>
          </div>
        </div>
