        ...
        <div class="row h-100">
          <div class="col-12 my-auto">
            <div class="masthead-content text-white py-5 py-md-0">
             ...
             <form method="get" id="loginfrm" action="UserController">
              	...
              	<div class="row">
              		<div class="col-md-12">
               			<div class="input-group" style="margin-top: 20px">
                  			<button class="btn btn-secondary"  href="home.jsp" type="button">Login</button>
                  		<!-- 	<a href="registration.jsp">Not yet Registered?Sign up here....</a> -->
                		</div>
                	</div>
                </div>
                </form>
